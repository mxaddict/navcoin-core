...
Also test that nodes that send unsupported service bits to navcoind are disconnected
...
class CNodeNoVersionBan(CLazyNode):
    ...
    # NOTE: implementation-specific check here. Remove if navcoind ban behavior changes
    def on_open(self):
        super().on_open()
